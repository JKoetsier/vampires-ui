...
(function() {
    ...
    angular
        .module('vampUi.services.executionHelper.mock', [])
        .factory('ExecutionHelperServiceMock', [
            ExecutionHelperServiceMock
        ]);

    /**
     * @namespace ExecutionHelperServiceMock
     * @desc Mocked version of the ExecutionHelperService
     * @memberOf Services
     */
    function ExecutionHelperServiceMock() {
