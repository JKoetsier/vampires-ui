...
(function() {
    ...
    angular
        .module('vampUi.services.executionDataExtract', [])
        .factory('ExecutionDataExtractService', ExecutionDataExtractService);


    /**
     * @namespace ExecutionDataExtractService
     * @desc Processes the execution data returned by the back-end
     * @memberOf Services
     */
    function ExecutionDataExtractService() {
