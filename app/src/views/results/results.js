(function() {
    ...
    angular.module('myApp.results', ['ngRoute'])
        ...
        .controller('ResultsController', ['$scope', 'ExecutionHelperService',
            'ApiClientService', 'Execution', 'Configuration', 'Resource', '$routeParams', 'ExecutionDataExtractService', function($scope, ExecutionHelperService, ApiClientService, Execution, Configuration, Resource, $routeParams, ExecutionDataExtractService) {
                    ...
                    Execution.get($scope.execution.id, function(execution) {
                        ...
                        execution.getWorkload(function(workload) {
                            ...
                            for (var key in $scope.costStats) {
                                ...
                                if ($scope.costStats[key].count && $scope.costStats[key].count > 0) {
